...
Namespace SpreadsheetChartAPISamples
    Public Class Form1
        ...
        Private WithEvents btnOpenExcel As SimpleButton
        ...
        Private Sub RearrangeExamples()
            ...
            Do While i < examples.Count
                Dim group As CodeExampleGroup = examples(i)
                If group.Name.StartsWith("Sparkline") Then
                    examples.RemoveAt(i)
...
'            #End Region
        ...
        Private Sub InitializeComponent()
            ...
            Me.horizontalSplitContainerControl1.Panel2.Controls.Add(Me.btnOpenExcel)
            ...
            Me.horizontalSplitContainerControl1.SplitterPosition = 69
            ...
            Me.xtraTabControl1.Size = New System.Drawing.Size(945, 537)
            ...
            Me.xtraTabPage1.Size = New System.Drawing.Size(939, 509)
            ...
            Me.richEditControlCS.Size = New System.Drawing.Size(939, 509)
            ...
            Me.xtraTabPage2.Size = New System.Drawing.Size(939, 509)
            ...
            Me.richEditControlVB.Size = New System.Drawing.Size(939, 509)
        ...
        Private Sub btnOpenExcel_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnOpenExcel.Click
            Dim fileName As String = "SampleChart.xlsx"
